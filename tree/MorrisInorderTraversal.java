...
class MorrisInorderTraversal extends ConstructBinaryTree
{	
    public static List<Integer> inorderTraversal(TreeNode root) {
        
        //use morris inorder tarversal to get inorder without taking any extra space //use threaded binary tree
    ...
    public static void main(String args[])
    {
        //create tree from given values
		 ...
		 System.out.println("Inorder traversal of given binary tree is " + list);
    }
}